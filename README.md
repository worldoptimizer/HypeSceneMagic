...
| `data-transition-delay`        | Delay before the transition starts. **Unitless values are factors relative to the total duration** (e.g., `0.5` equals 50%). Can also be percentages (`50%`) or time units (`0.5s`, `500ms`). | 0, 0.5, 50%, 0.5s           |
