...
document.head.appendChild(k)}});return{version:"2.7.1",getDefault:z,setDefault:function(a,f){typeof a=="object"?H=a:H[a]=f},clearCachedMagicProperties:function(a){a?D.delete(a):D=new WeakMap},getTransitionIdentifiers:B,registerAnimation:T}}());
